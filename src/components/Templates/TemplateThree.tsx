...
const TemplateThree = ({currentTime, sentences}: CustomParagraphProps) => {
  ...
  const paragraph = useDerivedValue(() => {
    ...
    const textStyle: SkTextStyle = {
      ...
      fontSize: TEMPLATE_DETAILS.fontSize,
      fontStyle: {
    ...
    currentSentence.value.words.forEach((word, _index) => {
      ...
      paragraphBuilder.pushStyle({
        ...
        fontSize: isWordTimePassed ? 32 : TEMPLATE_DETAILS.fontSize,
      });
